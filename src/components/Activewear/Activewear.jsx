...
function ActivewearRow() {
    return (
        <div className="bottomrow w-[1428px] h-[445px] grid grid-cols-6 mx-auto gap-x-[26px] my-[20px]">
            <h1 className="col-span-6 font-normal text-[31px] leading-[37.2px]">Activewear</h1>
