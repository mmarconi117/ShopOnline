...
export const BS_BeautyAndPersonal = () => {
  ...
  return (
    <section className="relative w-full min-[1512px]:max-w-min flex flex-col items-start pt-8 px-2 pb-10 gap-4  min-[465px]:justify-center min-[465px]:pt-8 min-[465px]:pb-16 min-[465px]:px-10 min-[465px]:gap-6">
...
export default BS_BeautyAndPersonal;
