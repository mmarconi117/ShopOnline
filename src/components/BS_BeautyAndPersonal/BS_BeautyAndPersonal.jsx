...
export const BS_BeautyAndPersonal = () => {
  ...
  return (
    <section className="relative w-full flex flex-col items-start pt-8 pl-4 pb-10 gap-4  min-[391px]:justify-center min-[391px]:pt-8 min-[391px]:pb-16 min-[391px]:pl-10 min-[391px]:gap-6">
