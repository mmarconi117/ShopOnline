...
export const BS_HomeAndOffice = () => {
  ...
  return (
    <section className="relative w-full flex flex-col items-start pt-8 pl-4 pb-2 gap-4  min-[391px]:justify-center min-[391px]:py-8 min-[391px]:pl-10 min-[391px]:gap-6">
