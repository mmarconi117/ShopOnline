const ReturnPolicy = () => {
    const items = [
        ...
        },
        {
            ...
            sections: [
                {
                    description:
                        'Click on the "Return Order" button on our website.',
                },
                {
                    description:
    ...
    return (
        <div id="return-policy-component">
            <div>
                <p> Return Policy</p>
            </div>
            <div>
                <p>
                    At SONNY, we strive to ensure that our customers are
                    completely satisfied with their purchases. However, we
                    understand that there may be instances where you need to
                    return a product. Our return policy is designed to be fair
                    and transparent, making the process easy for you.
                </p>
            </div>
            <div>{policies}</div>
        </div>
