...
const Menu = () => {
  ...
  return (
    <div className="hidden py-3 flex-col min-w-max rounded-[10px] bg-white gap-3 lg:flex font-Roboto">
      <p className="py-[6px] px-4 text-xl font-bold leading-6 w-[280px] xl`:w-[316px]">Categories</p>
