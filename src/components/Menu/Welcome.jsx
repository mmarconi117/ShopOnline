...
const Welcome = () => {
  return (
    <div className="hidden lg:flex flex-col py-5 min-h-[636px] px-[10px] items-center rounded-[10px] bg-white">
      ...
      <div className='bg-gray-300 h-full w-[260px] xl:w-[271px] rounded-lg'>
        {/* Content goes here */}
      </div>
    </div>
  );
