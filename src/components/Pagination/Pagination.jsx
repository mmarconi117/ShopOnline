        ...
        >
            <div className="flex items-center justify-between px-4 py-3 sm:px-6">
                <div className="flex flex-1 justify-between sm:hidden">
                    <a
                        href="#"
                        className="relative inline-flex items-center rounded-md border border-gray-300 bg-red-200 px-4 py-2 text-sm font-medium text-[#09618E] hover:bg-gray-50"
                    >
                        Previous
                    </a>
                    <a
                        href="#"
                        className="relative ml-3 inline-flex items-center rounded-md border border-gray-300 bg-white px-4 py-2 text-sm font-medium text-[#09618E] hover:bg-gray-50"
                    >
                        Next
                    </a>
                </div>
                    ...
                    <div>
                        ...
                        >
                            <button
                                ...
                                disabled={isPrevBtn}
                                className="relative inline-flex items-center rounded-l-md px-2 py-2 text-[#09618E] hover:bg-gray-50 disabled:cursor-not-allowed hover:cursor-pointer focus:z-20 focus:outline-offset-0 ml-5"
                            >
                                <div className="mr-5">
                                    <svg
                                        width="16"
                            ...
                            <button
                                ...
                                disabled={isNextBtn}
                                className="relative inline-flex items-center rounded-r-md px-2 py-2 text-[#09618E] hover:bg-gray-50 focus:z-20 disabled:cursor-not-allowed focus:outline-offset-0"
                            >
