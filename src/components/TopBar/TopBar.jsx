...
import svg from "../../assets/ICONS/sellersicons/logo.svg"
import search from "../../assets/ICONS/sellersicons/search.svg"
import notification from "../../assets/ICONS/sellersicons/notification.svg"
import user from "../../assets/ICONS/sellersicons/user.svg"
import downArrow from "../../assets/ICONS/sellersicons/downArrow.svg"
    ...
    <div className='w-full flex h-[102px]'>
      ...
      <div className='flex gap-[284px]'>
        <div className='w-[373px] h-[46px] border-[1px] border-solid border-[#EEC643] rounded-[5px] mt-[41px] mr-0 mb-[15px] ml-0 flex items-center py-[11px] px-[16px] box-border bg-[#FAFAFA]'>
          ...
          <input className='w-[100%] h-[19px] border-none outline-none bg-[#FAFAFA] text-[16px] font-Roboto placeholder-style ' placeholder='Search here...' />
        </div>
        ...
        <div className='flex justify-end items-center w-[473px] h-[42px] box-border mt-[44px] mb-[16px] gap-[63px] mr-[40px]'>
          <div className='flex gap-[52px] w-[290px] h-[42px] justify-end items-center'>
            <h4 className=' cursor-pointer font-Roboto'>Settings</h4>
            <h4 className='text-[#605d64] text-[16px] font-medium font-Roboto cursor-pointer'>Help</h4>
            <div className='relative bg-[#EEC643] w-[42px] h-[42px] border-[0.5px] border-solid border-[#e7e7e7] rounded-[50%] flex justify-center items-center cursor-pointer'>
              ...
              <div className='absolute top-[9px] right-[9px]'>
                <div className='relative bg-[#b3261e] w-[11px] h-[11px] rounded-[50%] flex items-center '>
                  <h4 className='text-[13px] w-[8px] h-[16px] absolute text-white top-[-5px] left-[1px] font-normal font-Roboto '>4</h4>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className='flex justify-center items-center w-[120px] h-[24px]'>
            ...
            <h4 className='mr-[9.33px] ml-[9px] cursor-pointer font-Roboto '>John Doe</h4>
