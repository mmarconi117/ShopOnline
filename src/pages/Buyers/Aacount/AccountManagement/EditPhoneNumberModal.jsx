...
const EditPhoneNumberModal = ({ setShowEditPhoneNumberModal }) => {
    return (
            ...
            <div className="flex flex-col items-center pb-20 text-base font-bold leading-5 bg-white w-[499px] text-zinc-800">
                <div className="flex flex-col justify-center self-stretch px-9 py-3.5 w-full text-xl bg-zinc-200 max-md:px-5 max-md:max-w-full">
                    <div className="flex gap-5 justify-between max-md:flex-wrap max-md:max-w-full">
                        <div className="my-auto">Edit Phone  number</div>
                        <button onClick={() => setShowEditPhoneNumberModal(false)}>
                            <img
                                loading="lazy"
                                src={closeBtn}
                ...
                <div className="w-full max-w-[388px] self-start justify-center px-16 py-3 mt-12 max-md:mt-10">Phone number</div>
                <input type='number'
