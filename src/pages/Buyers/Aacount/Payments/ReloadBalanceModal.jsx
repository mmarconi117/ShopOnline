...
const ReloadBalanceModal = ({setShowReloadBalanceModal}) => {
  return (
    <div className='fixed inset-0 bg-black bg-opacity-25 backdrop-blur-sm flex justify-center items-center'>
            <div className='w-[600px] flex flex-col'>
                <button
                    className='text-white text-xl place-self-end'
                    onClick={() => setShowReloadBalanceModal(false)}
                >
                    X
                </button>
                <div className='bg-white p-5 rounded'>
                    <div className="flex flex-col px-5 text-base font-bold leading-5 text-black max-w-[703px]">
                        <div className="w-full text-3xl max-md:max-w-full">Add funds to your gift card </div>
...
export default ReloadBalanceModal