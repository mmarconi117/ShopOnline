        ...
        <div className="gap-5 flex max-md:flex-col max-md:items-stretch max-md:gap-0">
          ...
          <div className="CartPage flex flex-col items-stretch w-[69%] max-md:w-full max-md:ml-0">
            <div className="ShipmentAddress flex grow flex-col items-stretch mt-16 max-md:max-w-full max-md:mt-10">
              <div className="text-zinc-900 text-2xl font-bold leading-8 whitespace-nowrap justify-center bg-neutral-50 pl-5 pr-16 py-4 items-start max-md:max-w-full max-md:pr-5">
                Shipment Address
              </div>
              <div className="text-zinc-900 text-2xl font-semibold leading-10">
                Mr Tony
              </div>
              <div className="text-zinc-900 text-xl font-medium leading-8 whitespace-nowrap">
                Top of New York, 84052
              </div>
              <div className="text-zinc-900 text-xl font-medium leading-8">
                +19048588048
              </div>
            </div>
          ...
          <div className="flex flex-col items-stretch w-[31%] ml-5 max-md:w-full max-md:ml-0">
            <div className="CartSummary justify-center items-center bg-white flex flex-col w-full px-12 py-6 max-md:mt-9 max-md:px-5">
              <div className=" text-zinc-800 text-2xl font-bold leading-8 self-center whitespace-nowrap">
                Cart Summary
              </div>
              {carts.map((item) => (
                <div key={item.id}>
              ...
              <div className="justify-center items-center bg-zinc-100 self-stretch flex gap-2.5 mt-8 px-20 py-2.5 rounded-md max-md:px-5">
                ...
                <div
                  href="#"
                  className="text-stone-950 text-center text-base leading-5 my-auto"
                  onClick={Checkout}
                >
                  {" "}
                  Checkout{" "}
            ...
            <div className="flex grow flex-col items-stretch max-md:max-w-full max-md:mt-6">
              <div className="PaymentMethod justify-center bg-neutral-50 flex flex-col pl-5 pr-20 py-5 items-start max-md:max-w-full max-md:px-5">
                ...
                <div className="items-center flex gap-4 mt-3">
                  ...
                  <div className="text-zinc-900 text-xl  leading-8 self-stretch grow whitespace-nowrap">
                    xxxx xxxx xxxx 2908
                  </div>
                </div>
              </div>
              ...
              <div className="items-start bg-white flex flex-col mt-9 pl-4 py-6 rounded-md max-md:max-w-full">
                <div className="text-zinc-800 text-2xl font-semibold leading-10 self-stretch whitespace-nowrap max-md:max-w-full">
                  Order Items
                </div>
                  ...
                  {carts.length > 0 ? (
                    <>
                      {carts.map((item) => (
                        ...
                        >
                          <img
                            className="bg-zinc-300 flex w-[165px] shrink-0 h-[124px] flex-col mx-auto max-md:mt-9"
                            src={item.product.avatar}
                            alt={item.product.name}
                          />
                          <div className="info flex grow basis-[0%] flex-col items-stretch mt-1.5 max-md:max-w-full">
                            <h3 className="text-zinc-700 text-base leading-6 max-md:max-w-full">
                              {item.product.name}
                            </h3>
                            <p className="text-zinc-500 text-sm leading-6 whitespace-nowrap mt-3.5 max-md:max-w-full">
                              {item.product.description}
                            </p>
                            <p className="text-zinc-700 text-2xl font-bold leading-8 grow whitespace-nowrap">
                              $ {item.product.price}
                            </p>
                            <a
                              href="#"
                            ...
                            <div
                              className="text-neutral-400 text-base leading-6 self-center grow whitespace-nowrap my-auto"
