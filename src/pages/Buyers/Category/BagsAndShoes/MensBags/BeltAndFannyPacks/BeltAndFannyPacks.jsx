import imagesList from "./BeltAndFannyPacksRowImages";
import arrow from "./../../../../../../assets/ICONS/RightPointer.svg";
import { useState } from "react";

function BeltAndFannyPacksRow() {
    ...
    return (
        <div className="relative w-full h-auto flex flex-col items-start gap-4 pt-8 px-4 sm:pt-16 sm:pb-1 sm:pl-10 sm:pr-0" >
            <h1 className=" text-[#313133] font-Roboto font-medium text-base sm:text-[31px] sm:font-bold sm:leading-[37.2px]">Belt And Fanny Packs</h1>
...
export default BeltAndFannyPacksRow;