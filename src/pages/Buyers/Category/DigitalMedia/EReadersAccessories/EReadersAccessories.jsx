import imagesList from './EReadersAccessoriesRowImages.jsx'
import arrow from '../../../../../assets/ICONS/RightPointer.svg'
import { useState } from 'react'
function EReadersAccessoriesRow() {
  ...
  return (
    <div className="relative w-full h-auto flex flex-col items-start gap-4 pt-8 px-4 pb-10 sm:pt-16 sm:pb-10 sm:pl-10 sm:pr-0">
      ...
      <ul className="flex w-full items-start gap-2 sm:gap-6 min-[390px]:overflow-x-auto overflow-hidden pr-4">
        {exploreItems}
...
export default EReadersAccessoriesRow
