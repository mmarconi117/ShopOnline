import imagesList from './WristWatchesRowImages.jsx'
import arrow from '../../../../../assets/ICONS/RightPointer.svg'
import { useState } from 'react'
function WristWatchesRow() {
  ...
  return (
    <div className="relative w-full h-auto flex flex-col items-start gap-4 pt-8 px-1 sm:pl-6 mb-5 sm:mb-10">
...
export default WristWatchesRow
