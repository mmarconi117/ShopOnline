import img1 from "../../../../../../assets/IMAGES/Men's-category/Grooming&perfume/Rectangle-1.jpeg";
import img2 from "../../../../../../assets/IMAGES/Men's-category/Grooming&perfume/Rectangle-2.jpeg";
import img3 from "../../../../../../assets/IMAGES/Men's-category/Grooming&perfume/Rectangle-3.jpeg";
import img4 from "../../../../../../assets/IMAGES/Men's-category/Grooming&perfume/Rectangle-4.jpeg";
import img5 from "../../../../../../assets/IMAGES/Men's-category/Grooming&perfume/Rectangle-5.jpeg";
import img6 from "../../../../../../assets/IMAGES/Men's-category/Grooming&perfume/Rectangle-6.jpeg";
import arrow from "../../../../../../assets/ICONS/RightPointer.svg"
import { useState } from "react";

const GroomingAndPerfume = () => {
    const imgList = [
        {
            id: 1,
    ...
    const exploreItems = Array.from({ length: itemsPerSlide }, (_, i) => {
        ...
        return (
            <li key={imgList[index % imgList.length].id} className="min-[391px]:hidden flex flex-col items-start bg-white min-w-[175px] min-h-[373px] sm:min-w-[219px] sm:h-auto p-2 pb-3 sm:p-[10px] sm:pb-[16px] rounded-[5px] border border-solid border-[#AEA9B1] gap-4 sm:gap-6">
                <img src={imgList[index % imgList.length].img} className="h-[200px] w-full object-cover rounded-[5px]"/>
    ...
    return (
        <div className={`relative w-full h-auto flex flex-col items-start gap-4 pt-8 px-1 sm:pt-16 sm:pb-1 sm:pl-6`} >
            <h1 className=" text-[#313133] font-Roboto font-medium text-base sm:text-[31px] sm:font-bold sm:leading-[37.2px]">Grooming</h1>
...
export default GroomingAndPerfume;
