import img1 from "../../../../../../assets/IMAGES/Men's-category/Shoes/Rectangle-1.jpeg";
import img2 from "../../../../../../assets/IMAGES/Men's-category/Shoes/Rectangle-2.jpeg";
import img3 from "../../../../../../assets/IMAGES/Men's-category/Shoes/Rectangle-3.jpeg";
import img4 from "../../../../../../assets/IMAGES/Men's-category/Shoes/Rectangle-4.jpeg";
import img5 from "../../../../../../assets/IMAGES/Men's-category/Shoes/Rectangle-5.jpeg";
import img6 from "../../../../../../assets/IMAGES/Men's-category/Shoes/Rectangle-6.jpeg";
...
const Shoes = () => {
    ...
    return (
        <div className={`relative w-full h-auto flex flex-col items-start gap-4 pt-8 px-1 sm:pt-16 sm:pb-1 sm:pl-6`} >
            <h1 className=" text-[#313133] font-Roboto font-medium text-base sm:text-[31px] sm:font-bold sm:leading-[37.2px]">Shoes</h1>
