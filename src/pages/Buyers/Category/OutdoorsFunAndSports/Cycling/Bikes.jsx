import imagesList from './BikesRowImages.jsx'
...
function BikesRow() {
    ...
    return (
        <div className="relative w-full h-auto flex flex-col items-start gap-4 pt-8 px-1 pb-10 sm:pt-16 sm:pb-10 sm:pl-10 sm:pr-0">
