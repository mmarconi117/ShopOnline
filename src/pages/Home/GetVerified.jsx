...
function GetVerified() {
  return (
    <div className="self-center flex w-[967px] max-w-full flex-col items-stretch mt-4 px-5">
      ...
      <div className="flex items-stretch justify-between gap-0 mt-4 p-15 max-md:max-w-full max-md:flex-wrap max-md:pr-5">
        <div className="items-start bg-white flex grow basis-[0%] flex-col px-6 py-7 h-screen rounded-md max-md:max-w-full max-md:px-5 overflow-y-scroll">
        ...
        <div className="items-stretch shadow-sm bg-zinc-100 flex basis-[0%] flex-col mt-6 pt-0.5 pb-12 px-0.5 rounded-lg self-start max-md:hidden">
          <div className="bg-zinc-500 flex shrink-0 h-[100px] flex-col mb-96 rounded-lg max-md:mb-10" />
        </div>
      </div>
    </div>
  );
