...
function ActivityFeed() {
    ...
    const feeds = products.map((product, index) => {
        return (
            <tr key={index}>
                <td className="w-[186px] h-[72px] border-r border-black justify-center text-center">
                    {/* Fetching immage here */}
                    <div className="bg-gray-400 w-[80px] h-[40px]">
                        <img
                            src={product.img}
                            className="bg-gray-400 w-[80px] h-[40px]"
                        />
                    </div>
                </td>
                ...
                <td className="w-[186px] h-[72px] border-r border-black self-center text-center justify-center">
                    <Link to={`FeedDetail/${index}`}>{product.brand}</Link>
                </td>
                <td className="w-[186px] h-[72px] border-r border-black self-center text-center justify-center">
                    {product.type}
                </td>
                        ...
                        <div className="flex w-full items-center justify-between space-y-3 max-md:max-w-full max-md:flex-wrap">
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    className="block w-full p-4 ps-10 text-base text-gray-900 border border-gray-300 rounded-lg bg-gray-50  0 dark:placeholder-gray-400 dark:text-black"
