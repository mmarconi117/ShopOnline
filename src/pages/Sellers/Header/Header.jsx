    ...
    <div className="fixed z-10 top-0 w-full bg-white justify-between flex items-center py-6">
      ...
      <div className="items-stretch hidden sm:flex justify-between gap-5 pr-4 md:gap-10 md:pr-8">
        <div className="items-stretch flex justify-between gap-5 md:gap-10 max-md:justify-center">
          <Link to="/sellers" className="text-zinc-600 text-base leading-6 whitespace-nowrap">Home</Link>
          <Link to="/sellers/onlinefulfillment" className="text-zinc-600 text-base leading-6 whitespace-nowrap">Settings</Link>
          <Link to="/sellers/helppage" className="text-zinc-600 text-base leading-6">Help</Link>
          <Link to="/sellers/notificationsettings" className="text-zinc-600 text-base leading-6 whitespace-nowrap">Notifications</Link>
        </div>
        <div className="flex items-stretch justify-between gap-1.5 max-md:justify-center">
          ...
          <div className="text-zinc-900 whitespace-nowrap text-base font-medium leading-6 self-center my-auto">
            {isAuthenticated && usersData.name ? usersData.name : null}
          </div>
          <img
            loading="lazy"
            src={ArrowDown}
